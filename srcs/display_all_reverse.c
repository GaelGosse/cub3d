...
/*   Updated: 2023/07/05 16:18:45 by mael             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	display_all_reverse_d(t_game *game, int key, int len_side)
{
	...
	if ((game->fov->angle > 90 && game->fov->angle < 180) \
	 && key == 'd' && game->fov->toggle == 'E' && game->map->pos_y + len_side >= game->map->height * game->img_size)
	{
...
{
	if ((game->fov->angle < 360 && game->fov->angle > 270) &&key == 'a' && game->fov->toggle == 'N' && game->map->pos_x - len_side < 0)
	{
	...
	if ((game->fov->angle > 0 && game->fov->angle < 90) && key == 'a' && game->fov->toggle == 'E' && game->map->pos_y -  len_side < 0)
	{
	...
	if ((game->fov->angle > 90 && game->fov->angle < 180) && key == 'a' && game->fov->toggle == 'S' && game->map->pos_x + len_side >= game->map->width * game->img_size)
	{
	...
	if ((game->fov->angle > 180 && game->fov->angle < 270) && key == 'a' && game->fov->toggle == 'W' && game->map->pos_y + len_side >= game->map->height * game->img_size)
	{
